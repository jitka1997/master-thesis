...
\label{newThing}
In this chapter, we focus on the TETRIS method introduced by \cite{tetris}. Specifically, we focus on the reordering technique briefly described in subsection \ref{reordering}.
