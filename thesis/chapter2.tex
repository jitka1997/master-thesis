...
\section{Improved Tetris}
TODO: Preformulovat aby viac sedelo do tohto usporiadania, do 12.4.

\subsection{Pruned Matrix}
...
%     \fbox{
%     \includegraphics[
%         trim=1cm 5cm 1cm 5cm, % left bottom right top
%         clip, 
%         width=0.4\textwidth
